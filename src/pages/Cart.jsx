...
const Cart = () => {
  ...
  return (
    <main className="min-h-screen bg-[#161732] p-8">
      <div className="max-w-7xl mx-auto bg-[#161732] rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <section className="lg:col-span-2">
            <div className="space-y-4">
              ...
              {items.map((item) => (
                <div
                  key={item.product_id}
                  className="cart-items flex items-center bg-[#7F1068] text-white gap-4 p-4 border rounded-lg"
                >
                  <img
                  className="cart-img"
                    src={item.image}
                  ...
                  />
                  <div className="flex-1 cart-content">
                    <h3 className="font-medium">{item.title}</h3>
                    <p className="text-sm text-zinc-300">{item.description}</p>
                    <div className="mt-3 flex items-center gap-3">
                      <div className="cart-actions flex items-center border rounded">
                        <button
                          onClick={() =>
          ...
          <aside className="lg:col-span-1">
            <div className="p-4 border rounded-lg bg-[#7F1068] text-white">
              ...
              <div className="flex justify-between py-1">
                <span className="text-sm text-zinc-300">Shipping</span>
                <span>{shipping}</span>
              </div>
              <div className="flex justify-between py-1">
                <span className="text-sm text-zinc-300">fee</span>
                <span>₹{fee}</span>
              </div>
              ...
              <button
                to="/"
                className="mt-3 w-full border border-gray-300 py-2 rounded-lg text-sm"
              >
                Continue Shopping
              </button>
            </div>
